...
# Make a PDF
pandoc styling/pdfStyle.yaml `cat structure/documentStructure_OSX.md` --quiet --toc --toc-depth 2 --filter pandoc-citeproc --standalone --pdf-engine=xelatex -o $outputName.pdf
