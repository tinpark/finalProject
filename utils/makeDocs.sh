...
# Make a PDF
pandoc styling/pdfStyle.yaml `cat structure/documentStructure_OSX.md` --lua-filter linkFlat.lua --quiet --toc --toc-depth 2 --filter pandoc-citeproc --standalone --pdf-engine=xelatex -o $outputName.pdf
